...
**Preset:** `presets/op-ratio-1to3.adv`  ·  **Concept:** _(add concept)_

> B Coarse=3. Hollow spectrum, missing every third partial.
...
_To persist: in Live, right-click the Operator title bar → **Save Preset** → save as `op-ratio-1to3` into the episode's `presets/` folder._
