# Patch tutorial — `op-poly-bell-step4`

**Preset:** `presets/op-poly-bell-step4.adv`  ·  **Concept:** _(add concept)_

> Step 3 + modulator C feeding B: Coarse 7, Level 50%, envelope similar but D=60ms. High-frequency shimmer adds.
...
_To persist: in Live, right-click the Operator title bar → **Save Preset** → save as `op-poly-bell-step4` into the episode's `presets/` folder._
