...
**Preset:** `presets/op-ratio-1to1.adv`  ·  **Concept:** _(add concept)_

> Algorithm 1, A and B sine. Coarse 1:1. Modulator Level 80. Hold C3 5s.
...
_To persist: in Live, right-click the Operator title bar → **Save Preset** → save as `op-ratio-1to1` into the episode's `presets/` folder._
