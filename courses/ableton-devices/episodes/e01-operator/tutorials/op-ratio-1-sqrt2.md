...
**Preset:** `presets/op-ratio-1-sqrt2.adv`  ·  **Concept:** _(add concept)_

> B Coarse=1, Fine=414 (approximates √2 offset). Bell/gong inharmonic.
...
_To persist: in Live, right-click the Operator title bar → **Save Preset** → save as `op-ratio-1-sqrt2` into the episode's `presets/` folder._
