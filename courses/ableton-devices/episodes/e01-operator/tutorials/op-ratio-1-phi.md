...
**Preset:** `presets/op-ratio-1-phi.adv`  ·  **Concept:** _(add concept)_

> B Coarse=1, Fine=618 (approximates φ ≈ 1.618). Stria-cloud inharmonic.
...
_To persist: in Live, right-click the Operator title bar → **Save Preset** → save as `op-ratio-1-phi` into the episode's `presets/` folder._
